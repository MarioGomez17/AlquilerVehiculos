...
{
    public class ReporteVehiculosPropietario
    {
        ...
        public ReporteVehiculosPropietario(int IdUsuario)
        {
            ...
            this.ConsultaSQL = "SELECT " +
                ...
                "WHERE alquiler_vehiculos.vehiculo.Propietario_Vehiculo = " + Propietario.Id + " " +
                "GROUP BY " +
                "alquiler_vehiculos.tipo_vehiculo.Nombre_TipoVehiculo, " +
                "alquiler_vehiculos.marca_vehiculo.Nombre_MarcaVehiculo, " +
                "alquiler_vehiculos.linea_vehiculo.Nombre_LineaVehiculo, " +
        ...
        public void GenerarReporteVehiculosPropietarioPDF()
        {
            string FilasTabla;
            int Indice = 0;
            int Alquileres = 0;
            ...
            string HTMLString = File.ReadAllText("./Templates/ReporteVehiculosPropietario.html").ToString();
                        ...
                        if (Indice % 2 != 0)
                        {
                            ListaListas.Last().Add(
                                            "<tr>" +
                                                ...
                                                "<td class='CeldaDatoTabla CeldaImpar'>" + (Lector.GetFloat(12) - Lector.GetFloat(13)).ToString() + "</td>" +
                                            "</tr>");
                        }
                        else
                        {
                            ListaListas.Last().Add(
                                            "<tr>" +
                                                ...
                                                "<td class='CeldaDatoTabla CeldaPar'>" + (Lector.GetFloat(12) - Lector.GetFloat(13)).ToString() + "</td>" +
                                            "</tr>");
                        }
                        Alquileres += Lector.GetInt32(11);
                        Precios += Lector.GetFloat(12);
                        Ganancias += Lector.GetFloat(12) - Lector.GetFloat(13);
                    }
                }
            }
            ...
            DocumentoFinal.Save("./wwwroot/Reportes/ReporteVehiculosPropietario" + this.Usuario.NumeroIdentificacion + ".pdf");
        }
        public void GenerarReporteVehiculosPropietarioEXCEL()
        {
            string RutaArchivo = "./wwwroot/Reportes/ReporteVehiculosPropietario" + this.Usuario.NumeroIdentificacion + ".xlsx";
            ...
            HojaCalculo.Cells[1, 8].Value = "CIUDAD";
            HojaCalculo.Cells[1, 9].Value = "ESTADO";
            HojaCalculo.Cells[1, 10].Value = "ALQUILERES REALIZADOS";
            HojaCalculo.Cells[1, 11].Value = "PRECIO ALQUILERES";
            HojaCalculo.Cells[1, 12].Value = "GANANCIAS NETAS";
            ...
            try
            {
                ...
                if (Lector.HasRows)
                {
                    ...
                    while (Lector.Read())
                    {
                        ...
                        HojaCalculo.Cells[Celda, 9].Value = Lector.GetString(9) + "(" + Lector.GetString(10) + ")";
                        HojaCalculo.Cells[Celda, 10].Value = Lector.GetInt32(11);
                        HojaCalculo.Cells[Celda, 11].Value = Lector.GetFloat(12);
                        HojaCalculo.Cells[Celda, 12].Value = Lector.GetFloat(12) - Lector.GetFloat(13);
        ...
        public void EnviarReportesVehiculosPropietarioPorCorreo(string CorreoReceptor)
        {
            try
            {
                GenerarReporteVehiculosPropietarioEXCEL();
                GenerarReporteVehiculosPropietarioPDF();
                string ReporteExcel = "./wwwroot/Reportes/ReporteVehiculosPropietario" + this.Usuario.NumeroIdentificacion + ".xlsx";
                string ReportePDF = "./wwwroot/Reportes/ReporteVehiculosPropietario" + this.Usuario.NumeroIdentificacion + ".pdf";
